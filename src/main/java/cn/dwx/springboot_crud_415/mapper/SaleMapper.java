package cn.dwx.springboot_crud_415.mapper;
...
public interface SaleMapper {
    ...
    @Insert("insert into sale values(default, #{price}, #{quantity}, #{price} * #{quantity}, curdate(), #{userid}, #{productid})")
    Integer add(Map map);

    @Update("update sale set productid = #{productid}, userid = #{userid}, price = #{price}, quantity = #{quantity}, totalprice = #{totalprice} where id = #{id}")
